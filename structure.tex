...
% 
% Altered by Jeff Solomon (jeff@jeffreysolo.com)
%
...
\makeoddhead{mio}{\scriptsize{\thetitle\hfill\leftmark}}{}{} % Header specification
...
%----------------------------------------------------------------------------------------
\newenvironment{acknowledgments}{\begin{vplace}[.5] \noindent\ignorespaces} {\end{vplace}}


%----------------------------------------------------------------------------------------
% DEDICATION FORMAT
%----------------------------------------------------------------------------------------
\newenvironment{dedication}{\begin{center}\begin{vplace}[.5]} {\end{vplace}\end{center}}
